...
int main(int argc, char *argv[])
{
	...
	if (args_get_flag("--generate_template")) {
		...
		const int char_width   = args_geti("--char_width");
		const int char_height  = args_geti("--char_height");
		const int char_columns = args_geti("--char_columns");
		const int char_rows    = args_geti("--char_rows");
